...
async function seed() {
    try {
        ...
        const additionalServices = [
            { name: "DJ Sound System", description: "Professional DJ with sound equipment", price: "50000", category: "sound" },
            { name: "Live Band", description: "5-piece live band performance", price: "150000", category: "sound" },
            { name: "Smoke Machine", description: "Stage smoke effects", price: "15000", category: "effects" },
            { name: "Cold Pyro", description: "Indoor fireworks display", price: "25000", category: "effects" },
            { name: "LED Dance Floor", description: "Illuminated dance floor", price: "40000", category: "effects" },
            { name: "Flower Decoration", description: "Fresh flower arrangements", price: "75000", category: "decoration" },
            { name: "Stage Decoration", description: "Premium stage setup", price: "100000", category: "decoration" },
            { name: "Photography", description: "Professional photography coverage", price: "80000", category: "other" },
            { name: "Videography", description: "Professional video coverage", price: "120000", category: "other" },
            { name: "Valet Parking", description: "Valet parking service", price: "30000", category: "other" },
        ];
