...
import { StaffMember, BanquetHall, FoodMenu, AdditionalService, Booking, Payment, BookingMenu, BookingService, CustomFoodItem, CustomService, BookingComment, BookingActivityLog, DateNote, Notification, } from "../db/models";
export const appRouter = router({
        ...
        getById: protectedProcedure
            ...
            return {
                ...
                hall: booking.banquetHallId ? {
                    id: booking.banquetHallId._id.toString(),
                    name: booking.banquetHallId.name,
                    capacity: booking.banquetHallId.capacity,
                } : null,
                ...
                menus: bookingMenus.map(bm => ({
                    ...
                    menuDetails: bm.foodMenuId ? {
                        id: bm.foodMenuId._id.toString(),
                        name: bm.foodMenuId.name,
                        pricePerPerson: bm.foodMenuId.pricePerPerson,
                    } : null,
                ...
                services: bookingServices.map(bs => ({
                    ...
                    serviceDetails: bs.serviceId ? {
                        id: bs.serviceId._id.toString(),
                        name: bs.serviceId.name,
                        price: bs.serviceId.price,
                    } : null,
    ...
    notifications: router({
        ...
        markAllAsRead: protectedProcedure.mutation(async ({ ctx }) => {
            ...
            await Notification.updateMany({ userId: ctx.user.staffId, isRead: false }, { isRead: true });
            return { success: true };
        }),
    }),
    // ==================== Dashboard Stats ====================
